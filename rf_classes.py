...
class MalwareClassifier:
    ...
    def evaluate_rf(self):
        ...
        print("Precisión del modelo RF: {:.2f}%".format(accuracy * 100))
...
# Predecir las etiquetas en el conjunto de prueba
classifier.predict_rf()

# Evaluar el rendimiento del clasificador rf
classifier.evaluate_rf()
