# -*- coding: utf-8 -*-
"""
Created on Sat Sep  9 15:19:46 2023
...
class MalwareClassifier:
    ...
    def predict_lda(self):
        ...
        self.y_pred = self.lda.predict(self.X_test)
    ...
    def evaluate_lda(self):
        ...
        print("Precisión del modelo LDA: {:.2f}%".format(accuracy * 100))
...
# Predecir las etiquetas en el conjunto de prueba
classifier.predict_lda()

# Evaluar el rendimiento del clasificador lda
classifier.evaluate_lda()
