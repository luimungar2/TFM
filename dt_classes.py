...
class MalwareClassifier:
    ...
    def evaluate_dt(self):
        ...
        print("Precisión del modelo DT: {:.2f}%".format(accuracy * 100))
...
# Entrenar el clasificador dt
classifier.train_dt()

# Predecir las etiquetas en el conjunto de prueba
classifier.predict_dt()

# Evaluar el rendimiento del clasificador dt
classifier.evaluate_dt()
